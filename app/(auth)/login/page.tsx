    ...
    <div className="w-full max-w-sm">
      ...
      <div className="bg-white rounded-2xl shadow-md border border-p-line p-8">
        ...
        <form onSubmit={handleLogin} className="flex flex-col gap-4">
          <div>
            <label className="block text-xs font-semibold text-p-ink2 uppercase tracking-wider mb-1">
              Email
            </label>
            <input
              type="email"
      ...
      <p className="text-center text-xs text-p-gray mt-6">
        Parabrisas El Piamonte · Sistema interno
      </p>
    </div>
  )
}
