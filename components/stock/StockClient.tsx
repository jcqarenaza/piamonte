...
Usá otro código o elegí esa pieza del buscador.`); return }
  ...
  function generarEtiqueta(s: typeof items[0]) {
    ...
    const OFFSET_TOP_MM = 48    // CALIBRADO 18/09 con la regla: el driver come 48mm (el "50" quedó en el borde). No genera 2ª página: el contenido se recorta dentro de la única hoja
